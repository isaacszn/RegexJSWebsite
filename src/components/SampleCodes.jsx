const SampleCodes = () => {
    return (
        <>
            <h1 className="sub-header">Sample Codes</h1>
            ...
            <ul>
                ...
                <li><code><span className="pink">RegexJS</span>.<span className="green">patternPassword</span>(<span className="light-green">email</span>);</code></li>
            </ul>
